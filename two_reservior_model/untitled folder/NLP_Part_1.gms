...
nl(n)     Reservoir nodes  /Res_1, Res_2, Res_3, Res_4, Res_5/;
...
SET t months /Jan1,Feb1,Mar1,Apr1,May1,Jun1,Jul1,Aug1,Sep1,Oct1,Nov1,Dec1,Jan2,Feb2,Mar2,Apr2,May2,Jun2,Jul2,Aug2,Sep2,Oct2,Nov2,Dec2/;
...
TABLE Supply(n,t) water supplies (m3 per sec)
            Jan1     Feb1   Mar1    Apr1    May1    Jun1    Jul1    Aug1    Sep1    Oct1    Nov1    Dec1    Jan2     Feb2 Mar2   Apr2   May2    Jun2    Jul2    Aug2    Sep2    Oct2    Nov2    Dec2
Supply_1    128      125    234     360     541     645     807     512     267     210     181     128     128      125  234    360    541     645     807     512     267     210     181     128
Supply_2    39       39     52      121     168     144     105     78      49      44      45      39      39       39   52     121    168     144     105     78      49      44      45      39;

TABLE Demand(n,t) water demands (m3 per sec)
            Jan1    Feb1 Mar1   Apr1        May1        Jun1        Jul1        Aug1        Sep1        Oct1    Nov1    Dec1    Jan2    Feb2 Mar2   Apr2        May2        Jun2        Jul2        Aug2        Sep2        Oct2    Nov2    Dec2
Divert_1    0       0    0      64.5        109.8       184.4       243.7       200.9       99.5        0       0       0       0       0    0      64.5        109.8       184.4       243.7       200.9       99.5        0       0       0
Divert_2    0       0    0      13.5        15.0        22.1        26.0        24.9        13.0        0       0       0       0       0    0      13.5        15.0        22.1        26.0        24.9        13.0        0       0       0
Outlet      500     500  500    100         100         100         100         500         500         500     500     500     500     500  500    100         100         100         100         500         500         500     500     500;
...
S.lo('Res_1' ,'Dec2' )    = 1000;
S.lo('Res_2' ,'Dec2' )    = 300;
S.lo('Res_3' ,'Dec2' )    = 1000;
S.lo('Res_4' ,'Dec2' )    = 300;
S.lo('Res_5' ,'Dec2' )    = 500;
...
loop((t),put t.TL:8, Q.L('Res_1',t):8.1, S.L('Res_1',t):8.1, R.L('Res_1',t):8.1,Q.L('Res_2',t):8.1, S.L('Res_2',t):8.1, R.L('Res_2',t):8.1, Q.L('Res_3',t):8.1, S.L('Res_3',t):8.1, R.L('Res_3',t):8.1, Q.L('Res_4',t):8.1, S.L('Res_4',t):8.1, R.L('Res_4',t):8.1, Q.L('Res_5',t):8.1, S.L('Res_5',t):8.1, R.L('Res_5',t):8.1 /;);