...
SET n_to_nr(n,n1) node n diverts water to node n1 (user node) / Simple_2.Divert_1,
  Simple_4.Divert_2,
  Simple_5.Outlet /;
...
file res /River2.txt/
put res;
put "Node Divert_1 Demand_1 Divert_2 Demand_2 Outlet Demand_O"/; loop((t),put t.TL:6, Divert.L('Divert_1',t):9.2, Demand('Divert_1',t):9.2,Divert.L('Divert_2',t):9.2, Demand('Divert_2',t):9.2, Divert.L('Outlet',t) :9.2, Demand('Outlet',t) :9.2 /;);

put /"Reservoirs  "/;
put "   Res1                    Res2"/;
put "Inflow Storage Release Inflow Storage Release"/;
put "Q-1 S-1 R-1 Q-2 S-2 R-2 "/;
loop((t),put t.TL:8, Q.L('Res_1',t):8.1, S.L('Res_1',t):8.1, R.L('Res_1',t):8.1, R.L('Res_1',t):8.1, Q.L('Res_2',t):8.1, S.L('Res_2',t):8.1, R.L('Res_2',t):8.1 /;);